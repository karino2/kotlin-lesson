...
かなりごちゃごちゃした図になってますが、注意してみると、susFuncAの最初のブロックと最後のブロックが呼び出し元のブロックとくっついている事、それらくっついたブロックを一つの大きなブロックとみると1から順番に番号が振れて、その順番に実行されていく事が分かると思います。
