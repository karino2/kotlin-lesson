...
この区画には、このシリーズでは当面は一切何も書きません。

間違えて書く事があまりにも多いので「1番目の区画には何も書かない！」と強く覚えてしまうのがいいでしょう。
...
### 3番目の区画でこれまでのコード（findViewByIdして何かするコード）を置いていた

これまで三番目の区画しか出てこなかったのであまり意識してなかったところですが、
